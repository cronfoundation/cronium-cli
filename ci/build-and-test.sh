#!/bin/bash
#
# This script builds Cron.CLI with dotnet 2.0, and runs the tests.
#
CONTAINER_NAME="cron-cli-ci"
...
# Build the Docker image (includes building the current Cron.CLI code)
